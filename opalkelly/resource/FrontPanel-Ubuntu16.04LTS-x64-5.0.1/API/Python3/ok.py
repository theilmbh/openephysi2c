...
class okBuffer(_object):
    ...
    __del__ = lambda self : None;
    def IsEmpty(self) -> "bool" : return _ok.okBuffer_IsEmpty(self)
    def GetSize(self) -> "size_t" : return _ok.okBuffer_GetSize(self)
    def __getitem__(self, *args) -> "unsigned char" : return _ok.okBuffer___getitem__(self, *args)
    def __setitem__(self, *args) -> "void" : return _ok.okBuffer___setitem__(self, *args)
...
class SwigPyIterator(_object):
    ...
    __del__ = lambda self : None;
    def value(self) -> "PyObject *" : return _ok.SwigPyIterator_value(self)
    def incr(self, n : 'size_t'=1) -> "swig::SwigPyIterator *" : return _ok.SwigPyIterator_incr(self, n)
    def decr(self, n : 'size_t'=1) -> "swig::SwigPyIterator *" : return _ok.SwigPyIterator_decr(self, n)
    def distance(self, *args) -> "ptrdiff_t" : return _ok.SwigPyIterator_distance(self, *args)
    def equal(self, *args) -> "bool" : return _ok.SwigPyIterator_equal(self, *args)
    def copy(self) -> "swig::SwigPyIterator *" : return _ok.SwigPyIterator_copy(self)
    def next(self) -> "PyObject *" : return _ok.SwigPyIterator_next(self)
    def __next__(self) -> "PyObject *" : return _ok.SwigPyIterator___next__(self)
    def previous(self) -> "PyObject *" : return _ok.SwigPyIterator_previous(self)
    def advance(self, *args) -> "swig::SwigPyIterator *" : return _ok.SwigPyIterator_advance(self, *args)
    def __eq__(self, *args) -> "bool" : return _ok.SwigPyIterator___eq__(self, *args)
    def __ne__(self, *args) -> "bool" : return _ok.SwigPyIterator___ne__(self, *args)
    def __iadd__(self, *args) -> "swig::SwigPyIterator &" : return _ok.SwigPyIterator___iadd__(self, *args)
    def __isub__(self, *args) -> "swig::SwigPyIterator &" : return _ok.SwigPyIterator___isub__(self, *args)
    def __add__(self, *args) -> "swig::SwigPyIterator *" : return _ok.SwigPyIterator___add__(self, *args)
    def __sub__(self, *args) -> "ptrdiff_t" : return _ok.SwigPyIterator___sub__(self, *args)
...
class okStrings(_object):
    ...
    __repr__ = _swig_repr
    def iterator(self) -> "swig::SwigPyIterator *" : return _ok.okStrings_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self) -> "bool" : return _ok.okStrings___nonzero__(self)
    def __bool__(self) -> "bool" : return _ok.okStrings___bool__(self)
    def __len__(self) -> "std::vector< std::string >::size_type" : return _ok.okStrings___len__(self)
    def pop(self) -> "std::vector< std::string >::value_type" : return _ok.okStrings_pop(self)
    def __getslice__(self, *args) -> "std::vector< std::string,std::allocator< std::string > > *" : return _ok.okStrings___getslice__(self, *args)
    def __setslice__(self, *args) -> "void" : return _ok.okStrings___setslice__(self, *args)
    def __delslice__(self, *args) -> "void" : return _ok.okStrings___delslice__(self, *args)
    def __delitem__(self, *args) -> "void" : return _ok.okStrings___delitem__(self, *args)
    def __getitem__(self, *args) -> "std::vector< std::string >::value_type const &" : return _ok.okStrings___getitem__(self, *args)
    def __setitem__(self, *args) -> "void" : return _ok.okStrings___setitem__(self, *args)
    def append(self, *args) -> "void" : return _ok.okStrings_append(self, *args)
    def empty(self) -> "bool" : return _ok.okStrings_empty(self)
    def size(self) -> "std::vector< std::string >::size_type" : return _ok.okStrings_size(self)
    def clear(self) -> "void" : return _ok.okStrings_clear(self)
    def swap(self, *args) -> "void" : return _ok.okStrings_swap(self, *args)
    def get_allocator(self) -> "std::vector< std::string >::allocator_type" : return _ok.okStrings_get_allocator(self)
    def begin(self) -> "std::vector< std::string >::iterator" : return _ok.okStrings_begin(self)
    def end(self) -> "std::vector< std::string >::iterator" : return _ok.okStrings_end(self)
    def rbegin(self) -> "std::vector< std::string >::reverse_iterator" : return _ok.okStrings_rbegin(self)
    def rend(self) -> "std::vector< std::string >::reverse_iterator" : return _ok.okStrings_rend(self)
    def pop_back(self) -> "void" : return _ok.okStrings_pop_back(self)
    def erase(self, *args) -> "std::vector< std::string >::iterator" : return _ok.okStrings_erase(self, *args)
    def __init__(self, *args): 
        this = _ok.new_okStrings(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args) -> "void" : return _ok.okStrings_push_back(self, *args)
    def front(self) -> "std::vector< std::string >::value_type const &" : return _ok.okStrings_front(self)
    def back(self) -> "std::vector< std::string >::value_type const &" : return _ok.okStrings_back(self)
    def assign(self, *args) -> "void" : return _ok.okStrings_assign(self, *args)
    def resize(self, *args) -> "void" : return _ok.okStrings_resize(self, *args)
    def insert(self, *args) -> "void" : return _ok.okStrings_insert(self, *args)
    def reserve(self, *args) -> "void" : return _ok.okStrings_reserve(self, *args)
    def capacity(self) -> "std::vector< std::string >::size_type" : return _ok.okStrings_capacity(self)
...
class okTRegisterEntries(_object):
    ...
    __repr__ = _swig_repr
    def iterator(self) -> "swig::SwigPyIterator *" : return _ok.okTRegisterEntries_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self) -> "bool" : return _ok.okTRegisterEntries___nonzero__(self)
    def __bool__(self) -> "bool" : return _ok.okTRegisterEntries___bool__(self)
    def __len__(self) -> "std::vector< okTRegisterEntry >::size_type" : return _ok.okTRegisterEntries___len__(self)
    def pop(self) -> "std::vector< okTRegisterEntry >::value_type" : return _ok.okTRegisterEntries_pop(self)
    def __getslice__(self, *args) -> "std::vector< okTRegisterEntry,std::allocator< okTRegisterEntry > > *" : return _ok.okTRegisterEntries___getslice__(self, *args)
    def __setslice__(self, *args) -> "void" : return _ok.okTRegisterEntries___setslice__(self, *args)
    def __delslice__(self, *args) -> "void" : return _ok.okTRegisterEntries___delslice__(self, *args)
    def __delitem__(self, *args) -> "void" : return _ok.okTRegisterEntries___delitem__(self, *args)
    def __getitem__(self, *args) -> "std::vector< okTRegisterEntry >::value_type const &" : return _ok.okTRegisterEntries___getitem__(self, *args)
    def __setitem__(self, *args) -> "void" : return _ok.okTRegisterEntries___setitem__(self, *args)
    def append(self, *args) -> "void" : return _ok.okTRegisterEntries_append(self, *args)
    def empty(self) -> "bool" : return _ok.okTRegisterEntries_empty(self)
    def size(self) -> "std::vector< okTRegisterEntry >::size_type" : return _ok.okTRegisterEntries_size(self)
    def clear(self) -> "void" : return _ok.okTRegisterEntries_clear(self)
    def swap(self, *args) -> "void" : return _ok.okTRegisterEntries_swap(self, *args)
    def get_allocator(self) -> "std::vector< okTRegisterEntry >::allocator_type" : return _ok.okTRegisterEntries_get_allocator(self)
    def begin(self) -> "std::vector< okTRegisterEntry >::iterator" : return _ok.okTRegisterEntries_begin(self)
    def end(self) -> "std::vector< okTRegisterEntry >::iterator" : return _ok.okTRegisterEntries_end(self)
    def rbegin(self) -> "std::vector< okTRegisterEntry >::reverse_iterator" : return _ok.okTRegisterEntries_rbegin(self)
    def rend(self) -> "std::vector< okTRegisterEntry >::reverse_iterator" : return _ok.okTRegisterEntries_rend(self)
    def pop_back(self) -> "void" : return _ok.okTRegisterEntries_pop_back(self)
    def erase(self, *args) -> "std::vector< okTRegisterEntry >::iterator" : return _ok.okTRegisterEntries_erase(self, *args)
    def __init__(self, *args): 
        this = _ok.new_okTRegisterEntries(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args) -> "void" : return _ok.okTRegisterEntries_push_back(self, *args)
    def front(self) -> "std::vector< okTRegisterEntry >::value_type const &" : return _ok.okTRegisterEntries_front(self)
    def back(self) -> "std::vector< okTRegisterEntry >::value_type const &" : return _ok.okTRegisterEntries_back(self)
    def assign(self, *args) -> "void" : return _ok.okTRegisterEntries_assign(self, *args)
    def resize(self, *args) -> "void" : return _ok.okTRegisterEntries_resize(self, *args)
    def insert(self, *args) -> "void" : return _ok.okTRegisterEntries_insert(self, *args)
    def reserve(self, *args) -> "void" : return _ok.okTRegisterEntries_reserve(self, *args)
    def capacity(self) -> "std::vector< okTRegisterEntry >::size_type" : return _ok.okTRegisterEntries_capacity(self)
...
class okDeviceSensors(_object):
    ...
    __repr__ = _swig_repr
    def iterator(self) -> "swig::SwigPyIterator *" : return _ok.okDeviceSensors_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self) -> "bool" : return _ok.okDeviceSensors___nonzero__(self)
    def __bool__(self) -> "bool" : return _ok.okDeviceSensors___bool__(self)
    def __len__(self) -> "std::vector< okTDeviceSensor >::size_type" : return _ok.okDeviceSensors___len__(self)
    def pop(self) -> "std::vector< okTDeviceSensor >::value_type" : return _ok.okDeviceSensors_pop(self)
    def __getslice__(self, *args) -> "std::vector< okTDeviceSensor,std::allocator< okTDeviceSensor > > *" : return _ok.okDeviceSensors___getslice__(self, *args)
    def __setslice__(self, *args) -> "void" : return _ok.okDeviceSensors___setslice__(self, *args)
    def __delslice__(self, *args) -> "void" : return _ok.okDeviceSensors___delslice__(self, *args)
    def __delitem__(self, *args) -> "void" : return _ok.okDeviceSensors___delitem__(self, *args)
    def __getitem__(self, *args) -> "std::vector< okTDeviceSensor >::value_type const &" : return _ok.okDeviceSensors___getitem__(self, *args)
    def __setitem__(self, *args) -> "void" : return _ok.okDeviceSensors___setitem__(self, *args)
    def append(self, *args) -> "void" : return _ok.okDeviceSensors_append(self, *args)
    def empty(self) -> "bool" : return _ok.okDeviceSensors_empty(self)
    def size(self) -> "std::vector< okTDeviceSensor >::size_type" : return _ok.okDeviceSensors_size(self)
    def clear(self) -> "void" : return _ok.okDeviceSensors_clear(self)
    def swap(self, *args) -> "void" : return _ok.okDeviceSensors_swap(self, *args)
    def get_allocator(self) -> "std::vector< okTDeviceSensor >::allocator_type" : return _ok.okDeviceSensors_get_allocator(self)
    def begin(self) -> "std::vector< okTDeviceSensor >::iterator" : return _ok.okDeviceSensors_begin(self)
    def end(self) -> "std::vector< okTDeviceSensor >::iterator" : return _ok.okDeviceSensors_end(self)
    def rbegin(self) -> "std::vector< okTDeviceSensor >::reverse_iterator" : return _ok.okDeviceSensors_rbegin(self)
    def rend(self) -> "std::vector< okTDeviceSensor >::reverse_iterator" : return _ok.okDeviceSensors_rend(self)
    def pop_back(self) -> "void" : return _ok.okDeviceSensors_pop_back(self)
    def erase(self, *args) -> "std::vector< okTDeviceSensor >::iterator" : return _ok.okDeviceSensors_erase(self, *args)
    def __init__(self, *args): 
        this = _ok.new_okDeviceSensors(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args) -> "void" : return _ok.okDeviceSensors_push_back(self, *args)
    def front(self) -> "std::vector< okTDeviceSensor >::value_type const &" : return _ok.okDeviceSensors_front(self)
    def back(self) -> "std::vector< okTDeviceSensor >::value_type const &" : return _ok.okDeviceSensors_back(self)
    def assign(self, *args) -> "void" : return _ok.okDeviceSensors_assign(self, *args)
    def resize(self, *args) -> "void" : return _ok.okDeviceSensors_resize(self, *args)
    def insert(self, *args) -> "void" : return _ok.okDeviceSensors_insert(self, *args)
    def reserve(self, *args) -> "void" : return _ok.okDeviceSensors_reserve(self, *args)
    def capacity(self) -> "std::vector< okTDeviceSensor >::size_type" : return _ok.okDeviceSensors_capacity(self)
...
class okCPLL22150(_object):
    ...
    def SetCrystalLoad(self, *args) -> "void" : return _ok.okCPLL22150_SetCrystalLoad(self, *args)
    def SetReference(self, *args) -> "void" : return _ok.okCPLL22150_SetReference(self, *args)
    def GetReference(self) -> "double" : return _ok.okCPLL22150_GetReference(self)
    def SetVCOParameters(self, *args) -> "bool" : return _ok.okCPLL22150_SetVCOParameters(self, *args)
    def GetVCOP(self) -> "int" : return _ok.okCPLL22150_GetVCOP(self)
    def GetVCOQ(self) -> "int" : return _ok.okCPLL22150_GetVCOQ(self)
    def GetVCOFrequency(self) -> "double" : return _ok.okCPLL22150_GetVCOFrequency(self)
    def SetDiv1(self, *args) -> "void" : return _ok.okCPLL22150_SetDiv1(self, *args)
    def SetDiv2(self, *args) -> "void" : return _ok.okCPLL22150_SetDiv2(self, *args)
    def GetDiv1Source(self) -> "okCPLL22150::DividerSource" : return _ok.okCPLL22150_GetDiv1Source(self)
    def GetDiv2Source(self) -> "okCPLL22150::DividerSource" : return _ok.okCPLL22150_GetDiv2Source(self)
    def GetDiv1Divider(self) -> "int" : return _ok.okCPLL22150_GetDiv1Divider(self)
    def GetDiv2Divider(self) -> "int" : return _ok.okCPLL22150_GetDiv2Divider(self)
    def SetOutputSource(self, *args) -> "void" : return _ok.okCPLL22150_SetOutputSource(self, *args)
    def SetOutputEnable(self, *args) -> "void" : return _ok.okCPLL22150_SetOutputEnable(self, *args)
    def GetOutputSource(self, *args) -> "okCPLL22150::ClockSource" : return _ok.okCPLL22150_GetOutputSource(self, *args)
    def GetOutputFrequency(self, *args) -> "double" : return _ok.okCPLL22150_GetOutputFrequency(self, *args)
    def IsOutputEnabled(self, *args) -> "bool" : return _ok.okCPLL22150_IsOutputEnabled(self, *args)
...
class okCPLL22393(_object):
    ...
    def SetCrystalLoad(self, *args) -> "bool" : return _ok.okCPLL22393_SetCrystalLoad(self, *args)
    def SetReference(self, *args) -> "void" : return _ok.okCPLL22393_SetReference(self, *args)
    def SetPLLParameters(self, *args) -> "bool" : return _ok.okCPLL22393_SetPLLParameters(self, *args)
    def SetPLLLF(self, *args) -> "bool" : return _ok.okCPLL22393_SetPLLLF(self, *args)
    def SetOutputDivider(self, *args) -> "bool" : return _ok.okCPLL22393_SetOutputDivider(self, *args)
    def SetOutputSource(self, *args) -> "bool" : return _ok.okCPLL22393_SetOutputSource(self, *args)
    def SetOutputEnable(self, *args) -> "void" : return _ok.okCPLL22393_SetOutputEnable(self, *args)
    def GetReference(self) -> "double" : return _ok.okCPLL22393_GetReference(self)
    def GetPLLP(self, *args) -> "int" : return _ok.okCPLL22393_GetPLLP(self, *args)
    def GetPLLQ(self, *args) -> "int" : return _ok.okCPLL22393_GetPLLQ(self, *args)
    def GetPLLFrequency(self, *args) -> "double" : return _ok.okCPLL22393_GetPLLFrequency(self, *args)
    def GetOutputDivider(self, *args) -> "int" : return _ok.okCPLL22393_GetOutputDivider(self, *args)
    def GetOutputSource(self, *args) -> "okCPLL22393::ClockSource" : return _ok.okCPLL22393_GetOutputSource(self, *args)
    def GetOutputFrequency(self, *args) -> "double" : return _ok.okCPLL22393_GetOutputFrequency(self, *args)
    def IsOutputEnabled(self, *args) -> "bool" : return _ok.okCPLL22393_IsOutputEnabled(self, *args)
    def IsPLLEnabled(self, *args) -> "bool" : return _ok.okCPLL22393_IsPLLEnabled(self, *args)
...
class okCDeviceSettings(_object):
    ...
    def GetString(self, *args) -> "std::string" : return _ok.okCDeviceSettings_GetString(self, *args)
    def GetInt(self, *args) -> "UINT32" : return _ok.okCDeviceSettings_GetInt(self, *args)
    def SetString(self, *args) -> "void" : return _ok.okCDeviceSettings_SetString(self, *args)
    def SetInt(self, *args) -> "void" : return _ok.okCDeviceSettings_SetInt(self, *args)
    def List(self) -> "std::vector< std::string,std::allocator< std::string > >" : return _ok.okCDeviceSettings_List(self)
    def Delete(self, *args) -> "void" : return _ok.okCDeviceSettings_Delete(self, *args)
    def Save(self) -> "void" : return _ok.okCDeviceSettings_Save(self)
...
class okCFirmware(_object):
    ...
    __repr__ = _swig_repr
    def PerformTasks(self, *args) -> "bool" : return _ok.okCFirmware_PerformTasks(self, *args)
...
class okCFirmwarePackage(_object):
    ...
    def Load(self, *args) -> "bool" : return _ok.okCFirmwarePackage_Load(self, *args)
    def GetFirmwareCount(self) -> "int" : return _ok.okCFirmwarePackage_GetFirmwareCount(self)
    def GetFirmware(self, num : 'int'=0) -> "okCFirmware *" : return _ok.okCFirmwarePackage_GetFirmware(self, num)
...
class okCScriptValue(_object):
    ...
    def IsNumber(self) -> "bool" : return _ok.okCScriptValue_IsNumber(self)
    def GetNumber(self) -> "long long" : return _ok.okCScriptValue_GetNumber(self)
    def IsBool(self) -> "bool" : return _ok.okCScriptValue_IsBool(self)
    def GetBool(self) -> "bool" : return _ok.okCScriptValue_GetBool(self)
    def IsString(self) -> "bool" : return _ok.okCScriptValue_IsString(self)
    def GetString(self) -> "std::string" : return _ok.okCScriptValue_GetString(self)
    def IsBuffer(self) -> "bool" : return _ok.okCScriptValue_IsBuffer(self)
    def GetBuffer(self) -> "okBuffer" : return _ok.okCScriptValue_GetBuffer(self)
...
class okCScriptValues(_object):
    ...
    __repr__ = _swig_repr
    def iterator(self) -> "swig::SwigPyIterator *" : return _ok.okCScriptValues_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self) -> "bool" : return _ok.okCScriptValues___nonzero__(self)
    def __bool__(self) -> "bool" : return _ok.okCScriptValues___bool__(self)
    def __len__(self) -> "std::vector< okCScriptValue >::size_type" : return _ok.okCScriptValues___len__(self)
    def pop(self) -> "std::vector< okCScriptValue >::value_type" : return _ok.okCScriptValues_pop(self)
    def __getslice__(self, *args) -> "std::vector< okCScriptValue,std::allocator< okCScriptValue > > *" : return _ok.okCScriptValues___getslice__(self, *args)
    def __setslice__(self, *args) -> "void" : return _ok.okCScriptValues___setslice__(self, *args)
    def __delslice__(self, *args) -> "void" : return _ok.okCScriptValues___delslice__(self, *args)
    def __delitem__(self, *args) -> "void" : return _ok.okCScriptValues___delitem__(self, *args)
    def __getitem__(self, *args) -> "std::vector< okCScriptValue >::value_type const &" : return _ok.okCScriptValues___getitem__(self, *args)
    def __setitem__(self, *args) -> "void" : return _ok.okCScriptValues___setitem__(self, *args)
    def append(self, *args) -> "void" : return _ok.okCScriptValues_append(self, *args)
    def empty(self) -> "bool" : return _ok.okCScriptValues_empty(self)
    def size(self) -> "std::vector< okCScriptValue >::size_type" : return _ok.okCScriptValues_size(self)
    def clear(self) -> "void" : return _ok.okCScriptValues_clear(self)
    def swap(self, *args) -> "void" : return _ok.okCScriptValues_swap(self, *args)
    def get_allocator(self) -> "std::vector< okCScriptValue >::allocator_type" : return _ok.okCScriptValues_get_allocator(self)
    def begin(self) -> "std::vector< okCScriptValue >::iterator" : return _ok.okCScriptValues_begin(self)
    def end(self) -> "std::vector< okCScriptValue >::iterator" : return _ok.okCScriptValues_end(self)
    def rbegin(self) -> "std::vector< okCScriptValue >::reverse_iterator" : return _ok.okCScriptValues_rbegin(self)
    def rend(self) -> "std::vector< okCScriptValue >::reverse_iterator" : return _ok.okCScriptValues_rend(self)
    def pop_back(self) -> "void" : return _ok.okCScriptValues_pop_back(self)
    def erase(self, *args) -> "std::vector< okCScriptValue >::iterator" : return _ok.okCScriptValues_erase(self, *args)
    def __init__(self, *args): 
        this = _ok.new_okCScriptValues(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args) -> "void" : return _ok.okCScriptValues_push_back(self, *args)
    def front(self) -> "std::vector< okCScriptValue >::value_type const &" : return _ok.okCScriptValues_front(self)
    def back(self) -> "std::vector< okCScriptValue >::value_type const &" : return _ok.okCScriptValues_back(self)
    def assign(self, *args) -> "void" : return _ok.okCScriptValues_assign(self, *args)
    def resize(self, *args) -> "void" : return _ok.okCScriptValues_resize(self, *args)
    def insert(self, *args) -> "void" : return _ok.okCScriptValues_insert(self, *args)
    def reserve(self, *args) -> "void" : return _ok.okCScriptValues_reserve(self, *args)
    def capacity(self) -> "std::vector< okCScriptValue >::size_type" : return _ok.okCScriptValues_capacity(self)
...
class okCScriptEngine(_object):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    def LoadScript(self, *args) -> "void" : return _ok.okCScriptEngine_LoadScript(self, *args)
    def RunScriptFunction(self, *args) -> "okCScriptValues" : return _ok.okCScriptEngine_RunScriptFunction(self, *args)
...
class okCFrontPanel(_object):
    ...
    def ConfigureFPGA(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_ConfigureFPGA(self, *args)
    def CreateLuaScriptEngine(self) -> "okstd::auto_ptr< okCScriptEngine >" : return _ok.okCFrontPanel_CreateLuaScriptEngine(self)
    def EnableAsynchronousTransfers(self, *args) -> "void" : return _ok.okCFrontPanel_EnableAsynchronousTransfers(self, *args)
    def GetDeviceCount(self) -> "int" : return _ok.okCFrontPanel_GetDeviceCount(self)
    def GetFPGAResetProfile(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_GetFPGAResetProfile(self, *args)
    def SetFPGAResetProfile(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_SetFPGAResetProfile(self, *args)
    def FlashEraseSector(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_FlashEraseSector(self, *args)
    def GetWireInValue(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_GetWireInValue(self, *args)
    def ReadRegister(self, *args) -> "UINT32" : return _ok.okCFrontPanel_ReadRegister(self, *args)
    def ReadRegisters(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_ReadRegisters(self, *args)
    def WriteRegister(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_WriteRegister(self, *args)
    def WriteRegisters(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_WriteRegisters(self, *args)
    def GetDeviceID(self) -> "std::string" : return _ok.okCFrontPanel_GetDeviceID(self)
    def GetDeviceListModel(self, *args) -> "okCFrontPanel::BoardModel" : return _ok.okCFrontPanel_GetDeviceListModel(self, *args)
    def GetDeviceListSerial(self, *args) -> "std::string" : return _ok.okCFrontPanel_GetDeviceListSerial(self, *args)
    def GetDeviceMajorVersion(self) -> "int" : return _ok.okCFrontPanel_GetDeviceMajorVersion(self)
    def GetDeviceMinorVersion(self) -> "int" : return _ok.okCFrontPanel_GetDeviceMinorVersion(self)
    def GetDeviceSensors(self) -> "std::vector< okTDeviceSensor,std::allocator< okTDeviceSensor > >" : return _ok.okCFrontPanel_GetDeviceSensors(self)
    def GetDeviceSettings(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_GetDeviceSettings(self, *args)
    def GetEepromPLL22150Configuration(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_GetEepromPLL22150Configuration(self, *args)
    def GetEepromPLL22393Configuration(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_GetEepromPLL22393Configuration(self, *args)
    def GetPLL22150Configuration(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_GetPLL22150Configuration(self, *args)
    def GetPLL22393Configuration(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_GetPLL22393Configuration(self, *args)
    def GetSerialNumber(self) -> "std::string" : return _ok.okCFrontPanel_GetSerialNumber(self)
    def GetHostInterfaceWidth(self) -> "int" : return _ok.okCFrontPanel_GetHostInterfaceWidth(self)
    def IsHighSpeed(self) -> "bool" : return _ok.okCFrontPanel_IsHighSpeed(self)
    def IsFrontPanel3Supported(self) -> "bool" : return _ok.okCFrontPanel_IsFrontPanel3Supported(self)
    def IsFrontPanelEnabled(self) -> "bool" : return _ok.okCFrontPanel_IsFrontPanelEnabled(self)
    def IsOpen(self) -> "bool" : return _ok.okCFrontPanel_IsOpen(self)
    def IsRemote(self) -> "bool" : return _ok.okCFrontPanel_IsRemote(self)
    def LoadDefaultPLLConfiguration(self) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_LoadDefaultPLLConfiguration(self)
    def OpenBySerial(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_OpenBySerial(self, *args)
    def ResetFPGA(self) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_ResetFPGA(self)
    def SetBTPipePollingInterval(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_SetBTPipePollingInterval(self, *args)
    def SetDeviceID(self, *args) -> "void" : return _ok.okCFrontPanel_SetDeviceID(self, *args)
    def SetEepromPLL22150Configuration(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_SetEepromPLL22150Configuration(self, *args)
    def SetEepromPLL22393Configuration(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_SetEepromPLL22393Configuration(self, *args)
    def SetPLL22150Configuration(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_SetPLL22150Configuration(self, *args)
    def SetPLL22393Configuration(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_SetPLL22393Configuration(self, *args)
    def SetTimeout(self, *args) -> "void" : return _ok.okCFrontPanel_SetTimeout(self, *args)
    ...
    def GetLastErrorMessage(self) -> "char const *" : return _ok.okCFrontPanel_GetLastErrorMessage(self)
    def GetDeviceInfo(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_GetDeviceInfo(self, *args)
    def GetBoardModel(self) -> "okCFrontPanel::BoardModel" : return _ok.okCFrontPanel_GetBoardModel(self)
    ...
    def ActivateTriggerIn(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_ActivateTriggerIn(self, *args)
    def IsTriggered(self, *args) -> "bool" : return _ok.okCFrontPanel_IsTriggered(self, *args)
    def UpdateTriggerOuts(self) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_UpdateTriggerOuts(self)
    def SetWireInValue(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_SetWireInValue(self, *args)
    def UpdateWireIns(self) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_UpdateWireIns(self)
    def GetWireOutValue(self, *args) -> "unsigned int" : return _ok.okCFrontPanel_GetWireOutValue(self, *args)
    def UpdateWireOuts(self) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_UpdateWireOuts(self)
    def Close(self) -> "void" : return _ok.okCFrontPanel_Close(self)
    def FlashWrite(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_FlashWrite(self, *args)
    def FlashRead(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_FlashRead(self, *args)
    def WriteToPipeIn(self, *args) -> "long" : return _ok.okCFrontPanel_WriteToPipeIn(self, *args)
    def ReadFromPipeOut(self, *args) -> "long" : return _ok.okCFrontPanel_ReadFromPipeOut(self, *args)
    def WriteToBlockPipeIn(self, *args) -> "long" : return _ok.okCFrontPanel_WriteToBlockPipeIn(self, *args)
    def ReadFromBlockPipeOut(self, *args) -> "long" : return _ok.okCFrontPanel_ReadFromBlockPipeOut(self, *args)
    def WriteToPipeInThr(self, *args) -> "long" : return _ok.okCFrontPanel_WriteToPipeInThr(self, *args)
    def ReadFromPipeOutThr(self, *args) -> "long" : return _ok.okCFrontPanel_ReadFromPipeOutThr(self, *args)
    def WriteToBlockPipeInThr(self, *args) -> "long" : return _ok.okCFrontPanel_WriteToBlockPipeInThr(self, *args)
    def ReadFromBlockPipeOutThr(self, *args) -> "long" : return _ok.okCFrontPanel_ReadFromBlockPipeOutThr(self, *args)
    def ReadI2C(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_ReadI2C(self, *args)
    def WriteI2C(self, *args) -> "okCFrontPanel::ErrorCode" : return _ok.okCFrontPanel_WriteI2C(self, *args)
...
class okCFrontPanelDevices(_object):
    ...
    def GetCount(self) -> "int" : return _ok.okCFrontPanelDevices_GetCount(self)
    def GetSerial(self, *args) -> "std::string" : return _ok.okCFrontPanelDevices_GetSerial(self, *args)
    def Open(self, *args) -> "okstd::auto_ptr< okCFrontPanel >" : return _ok.okCFrontPanelDevices_Open(self, *args)
